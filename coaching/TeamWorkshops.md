...
description: Boost your team’s creativity, collaboration, and problem-solving skills. These tailored workshops are designed to unlock innovation, strengthen trust, and solve complex problems together. From design thinking to strategy alignment, each workshop is crafted to meet the unique needs of your team and organization.
masthead_image: assets/images/team.jpg
nav-menu: true
...
boxes:
  - title: "What to Expect"
    content: |
      Each workshop is designed to be interactive, engaging, and results-oriented. Expect hands-on activities, collaborative exercises, and actionable takeaways that your team can implement immediately. [Read how I work with clients](/WorkingTogether.html).
    items:
  ...
  <div class="content-cards">
    ...
    <div class="content-card faq-item expandable-card">
      ...
      <div class="faq-answer">
        <p>Design thinking isn’t always a muscle most executive teams get to flex. We’ll use it to tackle real challenges together by framing better questions, uncovering deeper insight, and unlocking new ways to drive innovation.</p>
        <ul>
...
<!-- END Expandable Workshops Section -->
  ...
  If you're curious, explore <a href="{{ 'WorkingTogether.html' | relative_url }}">how we can work together</a> or <a href="{{ 'AboutGagan.html' | relative_url }}">get to know me</a>.  
  When you're ready, <a href="#contact" class="next scrolly">reach out and let's chat</a> about how a workshop can help you and your team move forward.
